...
if (isset($_POST["submit"])) {
  ...
  if (@$_FILES['produk']['error'] > 0) {
    ...
    $tambah = sql("INSERT INTO produk (nama_produk,jenis,berat,harga_produk,qty_produk,deskripsi,gambar_produk) VALUES ('$nama_produk','$jenis','$berat','$harga_produk','$qty_produk','$deskripsi','$nama_gambar')");
    echo "
      <script>
              ...
              <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  ...
                  <select class="form-select" name="jenis" required>
                    <option selected disabled>Pilih jenis perhiasan</option>
                ...
                <div class="mb-3">
                  ...
                  <div class="row">
                    <div class="col-10">
                      <input type="text" class="form-control" id="berat" name="berat" placeholder="Berat Produk" required>
                    </div>
