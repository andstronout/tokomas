...
$sql_transaksi = sql("SELECT * FROM transaksi WHERE id_user='$_SESSION[id_pelanggan]' AND `status`='Belum Diproses'");
    ...
    <div class="container">
      ...
      <div class="row my-4 ">
        <div class="col-4 d-flex justify-content-center border-right">
          <a href="#" class="text-info">Belum Diproses</a>
        </div>
        ...
        <div class="col-4 d-flex justify-content-center border-left">
          <a href="pesanan_selesai.php" class="text-dark">Selesai</a>
        </div>
      </div>
    </div>
    <div class="container">
        ...
        if ($sql_transaksi->num_rows > 0) {
          foreach ($sql_transaksi as $transaksi) { ?>
            <div class="row" style="width: 100%;">
              <div class="col-10">
                <h5>Pesanan : <?= $transaksi['id_pesanan']; ?></h5>
              </div>
            </div>
            <?php
